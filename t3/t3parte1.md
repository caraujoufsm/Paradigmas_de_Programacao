...
# 3. Escolha algum predicado recursivo que esteja nos slides ou em qualquer outra fonte. 
# Faça a execução passo-a-passo de uma consulta com o predicado escolhido. Lembre-se de mostrar o código do predicado no seu arquivo t3parte1.md
```prolog
fat(0,1).
fat(N,F) :-
	N > 0,
